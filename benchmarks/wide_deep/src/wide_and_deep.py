...
class WideDeepModel(nn.Cell):
    ...
    def __init__(self, config):
        ...
        self.dense_layer_1 = DenseLayer(self.all_dim_list[0], self.all_dim_list[1], config.weight_bias_init,
                                        config.deep_layer_act, convert_dtype=config.use_mixed_precision, drop_out=config.dropout_flag)
        ...
        self.dense_layer_4 = DenseLayer(self.all_dim_list[3], self.all_dim_list[4], config.weight_bias_init,
                                        config.deep_layer_act, convert_dtype=config.use_mixed_precision, drop_out=config.dropout_flag)
        self.dense_layer_5 = DenseLayer(self.all_dim_list[4], self.all_dim_list[5], config.weight_bias_init,
                                        config.deep_layer_act, convert_dtype=config.use_mixed_precision, drop_out=config.dropout_flag)
        self.dense_layer_6 = DenseLayer(self.all_dim_list[5], self.all_dim_list[6], config.weight_bias_init,
                                        config.deep_layer_act, convert_dtype=config.use_mixed_precision, drop_out=config.dropout_flag)
        self.dense_layer_7 = DenseLayer(self.all_dim_list[6], self.all_dim_list[7], config.weight_bias_init,
                                        config.deep_layer_act, convert_dtype=config.use_mixed_precision, drop_out=config.dropout_flag)
        self.dense_layer_8 = DenseLayer(self.all_dim_list[7], self.all_dim_list[8], config.weight_bias_init,
                                        config.deep_layer_act, convert_dtype=config.use_mixed_precision, use_activation=False, drop_out=False)
    ...
    def construct(self, id_hldr, wt_hldr):
        ...
        deep_in = self.dense_layer_5(deep_in)
        deep_in = self.dense_layer_6(deep_in)
        deep_in = self.dense_layer_7(deep_in)
        deep_out = self.dense_layer_8(deep_in)
