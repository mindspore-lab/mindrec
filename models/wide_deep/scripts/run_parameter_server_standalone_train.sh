...
echo "Usage: bash run_parameter_server_standalone_train.sh EPOCHS DEVICE_TARGET DATASET SERVER_NUM SCHED_HOST
                                                           SCHED_PORT VOCAB_CACHE_SIZE [DEVICE_ID]
...
cp ${self_path}/../op_precision.ini ${execute_path}/worker/
